...
>(({ className, children, position = "popper", side = "bottom", ...props }, ref) => {
  // Extract side from props to use as default
  const sideProp = props.side || side;

  // If side is explicitly set to "bottom", prevent auto-flip
  const avoidCollisions = sideProp === "bottom" ? false : true;
    ...
    <SelectPrimitive.Portal>
      <SelectPrimitive.Content
        ...
        className={cn(
          ...
          "!transition-none !duration-0 !animate-none !transform-none",
          className,
        )}
        position={position}
        style={{
